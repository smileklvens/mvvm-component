...
class PersonalCenterModel : BaseViewModel(){
    ...
    fun getMeListBean(item:Int) {
        launch({
            ...
            mutableListOf.add(MeListItemBean(0,"员工号","001",false, StaticDemoActivity.HEAD_JOB_NUMBER))
            mutableListOf.add(MeListItemBean(0,"职位","产品经理",false, StaticDemoActivity.HEAD_POSITION))
            mutableListOf.add(MeListItemBean(0,"邮箱","001@ikang.com",false, StaticDemoActivity.HEAD_MAILBOX))
            mutableListOf.add(MeListItemBean(0,"生日","选择生日",false, StaticDemoActivity.HEAD_BIRTHDAY))
