...
import com.ikang.libmvi.util.EncryptUtils
...
inline fun <reified T> SharedPreferences.gson(defaultValue: T,key: String? = null) =
    object : ReadWriteProperty<Any, T> {
        ...
        override fun getValue(thisRef: Any, property: KProperty<*>): T {
            ...
            return if (TextUtils.isEmpty(s)) defaultValue else gson.fromJson(s, T::class.java)
        }
...
inline fun <reified T> SharedPreferences.gsonList(key: String? = null) =
    object : ReadWriteProperty<Any, List<T>> {
        ...
        override fun getValue(thisRef: Any, property: KProperty<*>): List<T> {
            ...
            return if (TextUtils.isEmpty(s)) emptyList() else gson.fromJson<List<T>>(s, object : TypeToken<List<T>>() {}.type)
        }
