...
//    private val mMsgBadge: ShapeBadgeItem
    ...
    init {
        ...
        val homeItem = BottomNavigationItem(
                R.drawable.nav_home_press,
                resources.getString(R.string.nav_bar_home)
        )
                .setInactiveIconResource(R.drawable.nav_home_normal)
        ...
        val msgItem = BottomNavigationItem(
                R.drawable.nav_msg_press,
                resources.getString(R.string.news_news)
        )
                .setInactiveIconResource(R.drawable.nav_msg_normal)
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)

        //我的
        val userItem = BottomNavigationItem(
                R.drawable.nav_user_press,
                resources.getString(R.string.nav_bar_user)
        )
                .setInactiveIconResource(R.drawable.nav_user_normal)
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)
